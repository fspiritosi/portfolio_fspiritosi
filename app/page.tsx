  ...
  return (
    <>
      ...
      <div className="flex justify-around mt-20">
        <Link href="/contact">
          <button className="md:rounded-full xs:rounded-lg dark:bg-sky-700 p-4 rounded-lg max-w-sm mx-auto my-0 w-48 mt-4 text-lg font-extrabold dark:hover:bg-sky-500 bg-sky-600 hover:bg-sky-400">
            Contactame
          </button>
        </Link>
